    ...
    <div class="bg-white shadow rounded-lg p-6">
        ...
        <form wire:submit="createQuiz" class="space-y-4">
            <div>
                ...
                <input type="text" wire:model="title" class="mt-1 w-full rounded-lg border-slate-300 shadow-sm">
                @error('title')
            ...
            <div>
                ...
                <textarea wire:model="description" rows="2" class="mt-1 w-full rounded-lg border-slate-300 shadow-sm"></textarea>
                @error('description')
                    <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                @enderror
            </div>
